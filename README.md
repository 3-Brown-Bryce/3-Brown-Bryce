...
**Repository:** A project folder with multiple different file including code and other aspects

**Cloning:** Copying a repository for personal use

**Committing and Pushing:** when you have a seperate fork you can push code to make it onto the main repository or if you are even just going you can also commit or push.
